...
object Distributions {
  ...
  case class Uniform(from: Int, to: Int) extends Distribution
  ...
  def inverseNormalCDF(p: Double): Double = {
    ...
    if (p < plow) {
      ...
      val r = ((((c(0) * q + c(1)) * q + c(2)) * q + c(3)) * q + c(4)) * q + c(5)
      val s = (((d(0) * q + d(1)) * q + d(2)) * q + d(3)) * q + 1
      r / s
    }
    ...
    // Rational approximation for upper region:
      ...
      val r = -1 * (((((c(0) * q + c(1)) * q + c(2)) * q + c(3)) * q + c(4)) * q + c(5))
      val s = (((d(0) * q + d(1)) * q + d(2)) * q + d(3)) * q + 1
      r / s
    }
    ...
    // Rational approximation for central region:
      ...
      val q = p - 0.5
      val r = q * q
      val s = (((((a(0) * r + a(1)) * r + a(2)) * r + a(3)) * r + a(4)) * r + a(5)) * q
      val t = ((((b(0) * r + b(1)) * r + b(2)) * r + b(3)) * r + b(4)) * r + 1
      s / t
    }
  }
}
